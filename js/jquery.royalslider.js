...
(function (m) {
    function u(b, e) {
        var c, a = this, g = navigator.userAgent.toLowerCase();
        a.uid = m.rsModules.uid++;
        a.ns = ".rs" + a.uid;
        var f = document.createElement("div").style, d = ["webkit", "Moz", "ms", "O"], h = "", k = 0, l;
        for (c = 0; c < d.length; c++)
            l = d[c], !h && l + "Transform" in f && (h = l), l = l.toLowerCase(), window.requestAnimationFrame || (window.requestAnimationFrame = window[l + "RequestAnimationFrame"], window.cancelAnimationFrame = window[l + "CancelAnimationFrame"] || window[l + "CancelRequestAnimationFrame"]);
        window.requestAnimationFrame ||
        (window.requestAnimationFrame = function (a, b) {
            var d = (new Date).getTime(), c = Math.max(0, 16 - (d - k)), e = window.setTimeout(function () {
                a(d + c)
            }, c);
            k = d + c;
            return e
        ...
        a._e1 = f = m(f + "</div></div>");
        var p = a.ns, h = function (b, d, c, e, f) {
            a._j1 = b + d + p;
            a._k1 = b + c + p;
            a._l1 = b + e + p;
            f && (a._m1 = b + f + p)
        ...
        a.msEnabled ? (a.msTouch = Boolean(1 < window.navigator.msMaxTouchPoints), a.hasTouch = !1, a._n1 = 0.2, h("MSPointer", "Down", "Move", "Up", "Cancel")) : (h("mouse", "down", "move",
        "up", "up"), "ontouchstart" in window || "createTouch" in document ? (a.hasTouch = !0, a._j1 += " touchstart" + p, a._k1 += " touchmove" + p, a._l1 += " touchend" + p, a._m1 += " touchcancel" + p, a._n1 = 0.5, a.st.sliderTouch && (a._f1 = !0)) : (a.hasTouch = !1, a._n1 = 0.2));
        ...
        a.slider.html(f);
        a._o1 = a.st.controlsInside ? a._e1 :
        a.slider;
        ...
        a._s1 = 0;
        a._e ? (a._t1 = "transition-property", a._u1 = "transition-duration", a._v1 = "transition-timing-function", a._w1 = a._x1 = a._g + "transform", a._f ? (d.webkit && !d.chrome && a.slider.addClass("rsWebkit3d"), /iphone|ipad|ipod/gi.test(navigator.appVersion), a._y1 = "translate3d(", a._z1 = "px, ", a._a2 = "px, 0px)") :
        (a._y1 = "translate(", a._z1 = "px, ", a._a2 = "px)"), a._l ? a._p1[a._g + a._t1] = a._g + "transform" : (d = {}, d[a._g + a._t1] = "opacity", d[a._g + a._u1] = a.st.transitionSpeed + "ms", d[a._g + a._v1] = a.st.css3easeInOut, f.css(d))) : (a._x1 = "left", a._w1 = "top");
        var n;
    ...
    u.prototype = {
        constructor: u, _i2: function (b) {
            ...
            function c(b, d) {
                ...
                if (h) {
                    ...
                    var c = b.attr("data-rsw"), e = b.attr("data-rsh");
            ...
            var d = this, h, k, l = d._z, p = d.numSlides;
            if (!isNaN(e))
                return f(e);
            var n = d.currSlideId, q, r = b ? Math.abs(d._o2 - d.currSlideId) >= d.numSlides - 1 ? 0 :
            1 : d._y, s = Math.min(2, r), v = !1, u = !1, t;
            for (k = n; k < n + 1 + s; k++)
            ...
            if (v)
                for (k = n; k < n + r + 1; k++)
                    t = f(k), q = Math.floor((d._u - (n - k)) / d.numSlides) * d.numSlides, (h = d.slides[t]) && c(h, t);
            if (u)
                for (k = n - 1; k > n - 1 - r; k--)
                    t = f(k), q = Math.floor((d._u - (n - k)) / p) * p, (h = d.slides[t]) && c(h, t);
            if (!b)
                for (s = f(n - r), n = f(n + r), r = s > n ? 0 : s, k = 0; k < p; k++)
                    s > n && k > s - 1 || !(k < r || k > n) || (h = d.slides[k]) &&
            ...
            var c = this, a = function () {
                if (!b.images)
                    ...
                    a && !a.is("img") && a.each(function () {
                        var a = m(this), c = '<img class="rsImg" src="' + (a.is("a") ? a.attr("href") : a.text()) + '" />';
                ...
                if (!b.isAppended && c.ev) {
                    ...
                    c._l2) || -1 !== d && 1 !== d)) || (a = { visibility: "visible", opacity: 0 }, a[c._g + "transition"] = "opacity 400ms ease-in-out", b.content.css(a), setTimeout(function () {
            ...
            var c = this, a, g = "touchstart" === b.type;
            c._s2 = g;
            c.ev.trigger("rsDragStart");
            if (m(b.target).closest(".rsNoDrag", c._r1).length)
                return c.dragSuccess =
                !1, !0;
            ...
            if (c._l2)
                ...
                if (g) {
                    ...
                    if (f && 0 < f.length)
                        a = f[0], 1 < f.length && (c._v2 = !0);
                    else
                        return
                } else
                    b.preventDefault(), a = b, c.msEnabled && (a = a.originalEvent);
                c._l2 = !0;
            ...
            if (this._l3) {
                var c = this._m3, a = b.pageX - this._b3, g = b.pageY - this._c3, f = this._h3 + a, d = this._h3 + g, h = e ? this._e3 : this._h, f = h ? f : d, d = this._z2;
                this._a3 = !0;
                this._b3 = b.pageX;
                this._c3 = b.pageY;
            ...
            var c = this, a, g = "touchmove" === b.type;
            if (!c._s2 || g) {
                if (g) {
                    if (c._r3)
                        return;
                    ...
                    a = b, c.msEnabled && (a = a.originalEvent);
            ...
            function a(a, b) {
                if (g._l || e)
                    h = (-g._u - g._d1) * g._w, k = Math.abs(g._p - h), g._c = k / b, a && (g._c += 250), g._c = c(g._c),
                    g._x3(h, !1)
            }
            var g = this, f, d, h, k;
            ...
            if (!g._s2 || d)
                if (g._s2 = !1, g.ev.trigger("rsDragRelease"), g._u3 = null, g._l2 = !1, g._r3 = !1, g._l3 = !1, g._m3 = 0, cancelAnimationFrame(g._t3), g._a3 && (e ? g._q3(g._h3) : g._l && g._p3(g._h3)), g._b.off(g._k1).off(g._l1), d && g._e1.off(g._m1), g._i1(), !g._a3 && !g._v2 && e && g._w3) {
                    ...
                    var n = f ? d.pageX : d.pageY, q = g._d3;
                    d = g._v;
                    var r = g.currSlideId, s = g.numSlides, v = f ? g._f3 : g._g3, u = g._z;
                    Math.abs(n - q);
                    f = n - d;
                    ...
                    if (0 === v || 1 >= s)
                        ...
                        if (e) {
                            ...
                            q + p < n ? 0 > v ? a(!1, d) : g._m2("prev", c(Math.abs(g._p - (-g._u - g._d1 + 1) * g._w) / d), !1, !0, !0) : q - p > n ? 0 < v ? a(!1, d) : g._m2("next", c(Math.abs(g._p - (-g._u - g._d1 - 1) * g._w) /
                            d), !1, !0, !0) : a(!1, d)
                    }
                }
        }, _p3: function (b) {
            ...
            if (this.st.autoScaleSlider) {
                var a = this.st.autoScaleSliderWidth, g = this.st.autoScaleSliderHeight;
            ...
            if (b || e != this.width || c != this.height) {
                ...
                for (e = 0; e < this.slides.length; e++)
                    b = this.slides[e], b.positionSet = !1, b && (b.images && b.isLoaded) && (b.isRendered =
                    !1, this._q2(b));
                if (this._e4)
                    for (e = 0; e < this._e4.length; e++)
                        b = this._e4[e], b.holder.css(this._i, (b.id + this._d1) * this._w);
                this._n2();
        ...
        c, a, g) {
            ...
            n = Boolean(0 < h);
            h = Math.abs(h);
            var q = Math.floor(k / f._y), r = Math.floor((k + (n ? l : -l)) / f._y), q = (n ? Math.max(q, r) : Math.min(q, r)) * f._y + (n ? f._y - 1 : 0);
            ...
            d._c, a ? d.st.easeInOut : d.st.easeOut)) : (h = d._g4, k = d._r1, k.stop(!0, !0).css({ opacity: 0, display: "block", zIndex: d._m }), d._c = d.st.transitionSpeed, k.animate({ opacity: 1 }, d._c, d.st.easeInOut), f(), h && h.data("rsTimeout", setTimeout(function () {
        ...
        _u2: function (b) {
            ...
            var b = window.getComputedStyle(this._p1.get(0), null).getPropertyValue(this._g + "transform").replace(/^matrix\(/i, "").split(/, |\)$/g), e = 0 === b[0].indexOf("matrix3d");
            ...
            if (!b.isRendered) {
                var c = b.content,
                    ...
                    h;
                b.videoURL && (a = "rsVideoContainer", "fill" !== d ? g = !0 : (h = c, h.hasClass(a) || (h = h.find("." + a)), h.css({ width: "100%", height: "100%" }), a = "rsMainSlideImage"));
                ...
                if (c) {
                    ...
                    if ("none" !== d || f) {
                        a = "fill" !== d ? this._d4 : 0;
                        h = this._b4 - 2 * a;
                        var m = this._c4 - 2 * a, n, q, r = {};
                        "fit-if-smaller" === d && (k > h || l > m) && (d = "fit");
                        if ("fill" === d || "fit" === d)
                            n = h / k, q = m / l, n = "fill" == d ? n > q ? n : q : "fit" == d ? n < q ? n : q : 1, k = Math.ceil(k * n, 10), l = Math.ceil(l * n, 10);
                        "none" !== d && (r.width = k, r.height = l, g && c.find(".rsImg").css({ width: "100%", height: "100%" }));
                        f &&
                        (
                        r.marginLeft = Math.floor((h - k) / 2) + a,
                        r.marginTop = Math.floor((m - l) / 2) + a);
                        c.css(r)
                    }
                }
            }
        ...
        return this.each(function () {
            ...
            if ("object" !== typeof b && b) {
                if ((c = c.data("royalSlider")) && c[b])
                    return c[b].apply(c, Array.prototype.slice.call(e,
                    1))
            } else
...
(function (f) {
    f.extend(f.rsProto, {
        _h6: function () {
            ...
            var a = this, b = "rsThumbs", d = a.st.thumbs,
            c = "", g, e, h = d.spacing;
            a._j5 = !0;
            ...
            for (var k = 0; k < a.numSlides; k++)
                e = a.slides[k], c += "<div" + g + ' class="rsNavItem rsThumb">' + e.thumbnail + a._o6 +
                "</div>";
            c = f(c + "</div></div>");
            g = {};
            ...
            var d = 0, c, f = a * this._t6 + 2 * this._t6 - this._v6 + this._n3, e = Math.floor(this._i3 / this._t6);
